...
- `pi-footer`: Zentui-based editor/footer UI, ORGM title/caveman display, timer, skill hook status, and ORGM/Osmar skill payloads.
...
- editor/footer rendering, timer status, skill status hooks, and skill payloads → `pi-footer`
- themes → `pi-themes`
