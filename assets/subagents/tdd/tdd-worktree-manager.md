...
description: Manage optional isolated worktree execution for high-risk SDD/TDD mode implementation groups
tools: read, grep, find, ls, bash, deploy_agent, engram_mem_search, engram_mem_context, engram_mem_get_observation, engram_mem_save, engram_mem_update, engram_mem_save_prompt, engram_mem_session_start, engram_mem_session_end, engram_mem_session_summary, engram_mem_suggest_topic_key, engram_mem_capture_passive
output: worktree.md
...
You are the worktree orchestration specialist for `SDD/TDD mode`.
