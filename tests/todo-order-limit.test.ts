...
assert.deepEqual(
  ...
  ["pending:1", "pending:3", "in_progress:5", "completed:2", "completed:4", "deleted:6"],
  "visible tasks should put unfinished ids first, completed ids last, deleted last when included",
);
